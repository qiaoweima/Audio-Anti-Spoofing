...
if __name__ == '__main__':
    ...
    # root_path = 'spoof_15/'
    # train_protocol_path = root_path + 'CM_protocol/cm_train.trn'
    # dev_protocol_path   = root_path + 'CM_protocol/cm_develop.ndx'
    # eval_protocol_path  = root_path + 'CM_protocol/cm_evaluation.ndx'
